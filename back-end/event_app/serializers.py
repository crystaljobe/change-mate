...
class EventDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta: 
        model = Event
        fields = ['id', 'title', 'startTime', 'startDate', 'endTime', 'endDate', 'time_zone','event_type', 'virtual_event_link', 'event_venue', 'event_venue_address', 'description', 'event_photo', 'category', 'users_attending', 'num_users_attending', 'collaborators', 'location', 'lat', 'lon']
